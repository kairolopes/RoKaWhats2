...
const PHONE = '556285635204'; // Phone from user logs
...
// CONSTRUCT URL WITHOUT '/contacts' TO REPRODUCE ERROR
// Original template has /contacts/profile-picture
// We want to test /profile-picture (like in Make)
const baseUrl = ZAPI_URL_TEMPLATE.split('/contacts/')[0];
const url = `${baseUrl}/profile-picture?phone=${PHONE}`;

console.log(`Testing Z-API Profile Picture URL (INCORRECT PATH): ${url}`);
